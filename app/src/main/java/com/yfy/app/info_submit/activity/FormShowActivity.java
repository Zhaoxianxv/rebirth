...
//	    toolbar.addMenuText(TagFinal.ONE_INT,"" );
    }
	@Override
	...
	protected void initDialog() {
		...
		pointDialog = new MyDialog(this, R.layout.layout_dialog, initId, listennerId);
...
//
	...
	private void submit(){
		...
		Object[] params = {
				...
				map.get("fqxm"),
				map.get("fqzd"),
				map.get("fqdw"), map.get("fqsj"),
				map.get("fqzw"), map.get("mqdh"),
				map.get("mqxm"), map.get("mqzd"),
				map.get("mqdw"), map.get("mqsj"),
				map.get("mqzw"), map.get("ljsw"),
				map.get("qt"), map.get("sex"),
				map.get("sg"), map.get("stuname"),
				map.get("szdz"), map.get("ydjn"),
				map.get("yscn"), map.get("yybd"),
				map.get("tz"), map.get("sfz")
		};
	...
	public boolean onSuccess(String result, WcfTask wcfTask) {
		...
		if (JsonParser.isSuccess(result)){
			...
			Toast.makeText(mActivity, "当前修改失败", Toast.LENGTH_SHORT).show();
