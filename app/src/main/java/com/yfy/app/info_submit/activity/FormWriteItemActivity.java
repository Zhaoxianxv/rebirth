...
import com.yfy.app.info_submit.frament.*;
...
public class FormWriteItemActivity extends BaseFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.info_activity_form_write_item);
		initTypeDialog();
		initView();
	}


	private ConfirmDateWindow dateWindow;
	private void initTypeDialog() {
		dateWindow = new ConfirmDateWindow(this);
		dateWindow.setCancelName("取消");
		dateWindow.setOnPopClickListenner(new ConfirmDateWindow.OnPopClickListenner() {
			@Override
			public void onClick(View view) {
				dateWindow.getTimeName();
				dateWindow.getTimeValue();
			}
		});
	}
