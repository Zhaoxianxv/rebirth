...
public class LineDataSet extends LineRadarDataSet<com.yfy.charting_mp.data.Entry> {
    ...
    public LineDataSet(List<com.yfy.charting_mp.data.Entry> yVals, String label) {
        super(yVals, label);
