...
public class CandleDataSet extends LineScatterCandleRadarDataSet<com.yfy.charting_mp.data.CandleEntry> {
    ...
    public CandleDataSet(List<com.yfy.charting_mp.data.CandleEntry> yVals, String label) {
        super(yVals, label);
    }

    @Override
    public DataSet<com.yfy.charting_mp.data.CandleEntry> copy() {

        List<com.yfy.charting_mp.data.CandleEntry> yVals = new ArrayList<com.yfy.charting_mp.data.CandleEntry>();
    ...
    protected void calcMinMax(int start, int end) {
        ...
        List<com.yfy.charting_mp.data.CandleEntry> entries = mYVals;
