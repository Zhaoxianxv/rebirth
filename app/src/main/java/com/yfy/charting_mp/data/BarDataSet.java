...
public class BarDataSet extends BarLineScatterCandleDataSet<com.yfy.charting_mp.data.BarEntry> {
    ...
    public BarDataSet(List<com.yfy.charting_mp.data.BarEntry> yVals, String label) {
        super(yVals, label);
    ...
    @Override
    public DataSet<com.yfy.charting_mp.data.BarEntry> copy() {

        List<com.yfy.charting_mp.data.BarEntry> yVals = new ArrayList<com.yfy.charting_mp.data.BarEntry>();

        for (int i = 0; i < mYVals.size(); i++) {
            yVals.add(((com.yfy.charting_mp.data.BarEntry) mYVals.get(i)).copy());
        }
     ...
     */
    private void calcEntryCountIncludingStacks(List<com.yfy.charting_mp.data.BarEntry> yVals) {
     ...
     * DataSet
     */
    private void calcStackSize(List<com.yfy.charting_mp.data.BarEntry> yVals) {
